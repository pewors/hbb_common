...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "<Alex1989>".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.hydesk.com.ar"];
pub const RS_PUB_KEY: &str = "EZljJDHxYdg3J8yievhYlErMJZk5vZv6Nh1glaJGIeM=";
